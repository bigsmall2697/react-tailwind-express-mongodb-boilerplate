...
const notificationIcons: { [key in NotificationType]: ReactNode } = {
...
export default function Notification({ open, onClose, duration = 5000, message, description, type = 'info' }: NotificationProps) {
